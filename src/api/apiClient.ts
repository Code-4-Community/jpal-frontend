...
export class ApiClient {
  ...
  public async editSurveyName(surveyUuid?: string, id?: number, newName?: string): Promise<void> {
    return this.patch(`/survey/${surveyUuid}`, { id: id, surveyName: newName }) as Promise<void>;
  }
}
